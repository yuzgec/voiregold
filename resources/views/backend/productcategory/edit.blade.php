...
@section('title', $Edit->title.' | Ürün Kategori Düzenle')
@section('content')
        ...
        <div class="col-12 col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <x-form-inputtext label="Ürün Açıklama" name="seo_desc"></x-form-inputtext>
                    <x-form-inputtext label="Ürün Anahtar Kelime " name="seo_key"></x-form-inputtext>
                </div>
            </div>
        </div>
